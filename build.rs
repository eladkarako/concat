...
#[inline]
fn get_string<'a>(table: &'a toml::Value, key: &str, default: &'a str) -> &'a str {
...
fn parse_version(version: &str) -> (u64, u64, u64, u64) {
    ...
    let release = parts.get(3).and_then(|v| v.parse().ok()).unwrap_or(0);
...
#[inline]
fn pack_version(major: u64, minor: u64, patch: u64, release: u64) -> u64 {
...
fn set_windows_resources(
    ...
    let path_manifest = manifest_dir.join("resources").join("app.manifest");
